...
```css
--color-gray-50        /* 最浅灰 #f9fafb */
--color-gray-100       /* 浅灰 #f3f4f6 */
--color-gray-200       /* #e5e7eb */
--color-gray-300       /* #d1d5db */
--color-gray-400       /* #9ca3af */
--color-gray-500       /* #6b7280 */
--color-gray-600       /* 深灰 #4b5563 */
--color-gray-700       /* #374151 */
--color-gray-800       /* #1f2937 */
--color-gray-900       /* 最深灰 #111827 */
```

### 主色变体（新增）

```css
--color-primary-50     /* 主色 + 90% 白色 */
--color-primary-100    /* 主色 + 80% 白色 */
--color-primary-200    /* 主色 + 70% 白色 */
--color-primary-300    /* 主色 + 60% 白色 */
--color-primary-400    /* 主色 + 40% 白色 */
--color-primary-500    /* 主色 + 20% 白色 */
--color-primary-600    /* 主色本身 */
--color-primary-700    /* 主色 + 10% 黑色 */
--color-primary-800    /* 主色 + 20% 黑色 */
--color-primary-900    /* 主色 + 30% 黑色 */
```
...
系统提供了统一的间距变量，用于 padding、margin、gap 等属性：
