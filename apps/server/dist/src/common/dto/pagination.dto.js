...
__decorate([
    ...
    (0, class_validator_1.Min)(1, { message: '页码至少为1' }),
...
__decorate([
    ...
    (0, class_validator_1.Min)(1, { message: '每页至少1条' }),
    (0, class_validator_1.Max)(100, { message: '每页最多100条' }),
    __metadata("design:type", Number)
...
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsIn)(['asc', 'desc'], { message: '排序方向只能是 asc 或 desc' }),
    __metadata("design:type", String)
